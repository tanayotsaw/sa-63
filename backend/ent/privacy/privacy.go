...
// The LessonplanQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type LessonplanQueryRuleFunc func(context.Context, *ent.LessonplanQuery) error

// EvalQuery return f(ctx, q).
func (f LessonplanQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.LessonplanQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.LessonplanQuery", q)
}

// The LessonplanMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type LessonplanMutationRuleFunc func(context.Context, *ent.LessonplanMutation) error

// EvalMutation calls f(ctx, m).
func (f LessonplanMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.LessonplanMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.LessonplanMutation", m)
}
