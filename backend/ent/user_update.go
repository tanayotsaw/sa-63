...
func (uu *UserUpdate) AddUserID(t ...*Teacher) *UserUpdate {
	ids := make([]int, len(t))
	for i := range t {
		ids[i] = t[i].ID
	}
...
// RemoveUserID removes User_ID edges to Teacher.
func (uu *UserUpdate) RemoveUserID(t ...*Teacher) *UserUpdate {
	ids := make([]int, len(t))
	for i := range t {
		ids[i] = t[i].ID
	}
...
// AddUserID adds the User_ID edges to Teacher.
func (uuo *UserUpdateOne) AddUserID(t ...*Teacher) *UserUpdateOne {
	ids := make([]int, len(t))
	for i := range t {
		ids[i] = t[i].ID
	}
...
// RemoveUserID removes User_ID edges to Teacher.
func (uuo *UserUpdateOne) RemoveUserID(t ...*Teacher) *UserUpdateOne {
	ids := make([]int, len(t))
	for i := range t {
		ids[i] = t[i].ID
	}
