...
func (uq *UserQuery) QueryUserID() *TeacherQuery {
	query := &TeacherQuery{config: uq.config}
...
func (uq *UserQuery) WithUserID(opts ...func(*TeacherQuery)) *UserQuery {
	query := &TeacherQuery{config: uq.config}
