...
declare class GitlabAuth implements OAuthApi, SessionStateApi {
    private readonly sessionManager;
    static create({ discoveryApi, environment, provider, oauthRequestApi, }: CreateOptions$1): GitlabAuth;
    sessionState$(): Observable<SessionState>;
...
declare class GoogleAuth implements OAuthApi, OpenIdConnectApi, ProfileInfoApi, BackstageIdentityApi, SessionStateApi {
    private readonly sessionManager;
    static create({ discoveryApi, environment, provider, oauthRequestApi, }: CreateOptions$2): GoogleAuth;
    sessionState$(): Observable<SessionState>;
...
declare class OAuth2 implements OAuthApi, OpenIdConnectApi, ProfileInfoApi, SessionStateApi {
    private readonly sessionManager;
    static create({ discoveryApi, environment, provider, oauthRequestApi, }: CreateOptions$3): OAuth2;
    sessionState$(): Observable<SessionState>;
...
declare class OktaAuth implements OAuthApi, OpenIdConnectApi, ProfileInfoApi, BackstageIdentityApi, SessionStateApi {
    private readonly sessionManager;
    static create({ discoveryApi, environment, provider, oauthRequestApi, }: CreateOptions$4): OktaAuth;
    sessionState$(): Observable<SessionState>;
...
declare class Auth0Auth implements OpenIdConnectApi, ProfileInfoApi, BackstageIdentityApi, SessionStateApi {
    private readonly sessionManager;
    static create({ discoveryApi, environment, provider, oauthRequestApi, }: CreateOptions$5): Auth0Auth;
    sessionState$(): Observable<SessionState>;
...
declare class MicrosoftAuth implements OAuthApi, OpenIdConnectApi, ProfileInfoApi, BackstageIdentityApi, SessionStateApi {
    private readonly sessionManager;
    static create({ environment, provider, oauthRequestApi, discoveryApi, }: CreateOptions$6): MicrosoftAuth;
    sessionState$(): Observable<SessionState>;
