...
declare type SidebarUserSettingsProps = {
    providerSettings?: React.ReactNode;
};
declare function SidebarUserSettings({ providerSettings, }: SidebarUserSettingsProps): JSX.Element;


declare const DefaultProviderSettings: () => JSX.Element;
